...
LengthConverter = (valNum) => {
    ...
    switch (optionTextOne) {
        ...
        case 'Kilometre':
            ...
            else if (optionTextTwo == "Kilometer") {
                value = valNum ;
            }
            else if (optionTextTwo == "Foot") {
                value = valNum * 3280.8;
        ...
        case 'Centimeters':
            ...
            else if (optionTextTwo == "Centimeter") {
                value = valNum ;
            }
            else if (optionTextTwo == "Foot") {
                value = valNum * 0.032808;
        ...
        case 'Micrometre':
            ...
            else if (optionTextTwo == "Micrometer") {
                value = valNum ;
            }
            else if (optionTextTwo == "Foot") {
                value = valNum / 304800;
        ...
        case 'Millimetre':
            ...
            else if (optionTextTwo == "Milimeter") {
                value = valNum ;
            }
            else if (optionTextTwo == "Foot") {
                value = valNum * 304.8;
...
TemperatureConverter = (valNum) => {
    ...
    switch (optionTextOne) {
        ...
        else if (optionTextTwo == "Fahrenhite") {
            value = valNum ;
        }
        else if (optionTextTwo == "Kalvin") {
...
VolumeConverter = (valNum) => {
    ...
    switch (optionTextOne) {
        ...
        else if (optionTextTwo == "Mililitres") {
            value = valNum ;
        }
        else if (optionTextTwo == "Gallons") {
            value = valNum / 3785;
